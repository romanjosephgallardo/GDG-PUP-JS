...
// Using let
let name = "Jace"; // Define a string here, e.g., "Juan Cruz"
let age = 19; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ['reading', 'gaming', 'coding', 'singing']; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using const
const pi = 143; // Define a number here, e.g., 3.14159
const birthYear = 1999; // Define a number here, e.g., 1990
const isEmployed = true; // Define a boolean here, e.g., true or false
const favoriteBooks = ["2005", "E=MC^2", "Angela"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = 55; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["black", "purple", "white"]; // Define an array here, e.g., ["red", "green", "blue"]
